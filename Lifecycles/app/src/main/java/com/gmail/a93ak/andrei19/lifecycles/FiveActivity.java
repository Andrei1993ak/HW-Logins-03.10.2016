...
public class FiveActivity extends AppCompatActivity {
    ...
    private void load() {
        String country = getApplicationContext().getSharedPreferences(ZeroActivity.PREFERENCES, MODE_PRIVATE).getString(COUNTRY, getResources().getString(R.string.null_value));
        if (!country.equals(getResources().getString(R.string.null_value)))
